 ...
 * Slug: trekking-blocks/blog-grid-layout
 * Categories: trekking-blocks, blog-grid-layout
 */
?>
...
<div class="wp-block-query"><!-- wp:post-template {"layout":{"type":"grid","columnCount":3},"fontSize":"small"} -->
